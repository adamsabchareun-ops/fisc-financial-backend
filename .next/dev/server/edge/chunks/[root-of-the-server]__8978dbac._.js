...
async function middleware(request) {
    ...
    if (user && request.nextUrl.pathname.startsWith('/login')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/horizon', request.url));
    }
    return response;
}
const config = {
