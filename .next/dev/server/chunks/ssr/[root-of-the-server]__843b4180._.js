...
"[project]/src/app/actions/data:5af3ee [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$5af3ee__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:5af3ee [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function HorizonPage() {
    ...
    const handleAllocate = async ()=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$5af3ee__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["allocateIncome"])('user-id-placeholder', income, buckets);
            if (result.success) {
                setIncomeInput('');
                setShowSuccess(true);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__843b4180._.js.map