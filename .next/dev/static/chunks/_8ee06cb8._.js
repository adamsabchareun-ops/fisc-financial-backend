...
const useHorizon = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useHorizon.useEffect": ()=>{
            // Simulate API delay for "Empathetic UX"
            const timer = setTimeout({
                "useHorizon.useEffect.timer": ()=>{
                    setData({
                        payPeriods: [
                            {
                                id: '1',
                        ...
                        sentimentLogs: [
                            {
                                id: '1',
                                logged_at: '2023-10-02T10:00:00Z',
                                score: 4,
                                note: 'Feeling good about savings'
                            }
                        ]
                    });
                    setLoading(false);
                }
            }["useHorizon.useEffect.timer"], 1500); // 1.5s delay
            return ({
                "useHorizon.useEffect": ()=>clearTimeout(timer)
            })["useHorizon.useEffect"];
        }
    }["useHorizon.useEffect"], []);
    return {
...
_s(useHorizon, "Zn4cs3026OJRBhxLd0Oqj+bUOXY=");
...
const BucketAllocations = ({ buckets })=>{
    ...
    const totalCurrent = buckets.reduce((acc, b)=>acc + b.current_amount, 0);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: [
                                                "$",
                                                bucket.current_amount.toLocaleString(),
                                                " / $",
...
function HorizonPage() {
    _s();
    const { data, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useHorizon$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHorizon"])();
    ...
    const projectedBuckets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HorizonPage.useMemo[projectedBuckets]": ()=>{
            ...
            if (income === 0) return data.allocationBuckets;
            // Simple distribution logic: Proportional based on remaining target or just target size? 
            // Let's use proportional to target amount for this demo as "bucket settings" placeholder.
            // Total Target
            const totalTarget = data.allocationBuckets.reduce({
                "HorizonPage.useMemo[projectedBuckets].totalTarget": (acc, b)=>acc + b.target_amount
            }["HorizonPage.useMemo[projectedBuckets].totalTarget"], 0);
            return data.allocationBuckets.map({
                "HorizonPage.useMemo[projectedBuckets]": (bucket)=>{
                    // ratio = bucket target / total target
                    const ratio = totalTarget > 0 ? bucket.target_amount / totalTarget : 0;
                    const allocated = income * ratio;
                    return {
                        ...bucket,
                        current_amount: bucket.current_amount + allocated
                    };
                }
            }["HorizonPage.useMemo[projectedBuckets]"]);
        }
...
_s(HorizonPage, "6+4yzgjGOtSrqNkoQtcrqzytVwg=", false, function() {
    return [
...
//# sourceMappingURL=_8ee06cb8._.js.map